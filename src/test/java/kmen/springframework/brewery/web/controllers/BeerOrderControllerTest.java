...
import kmen.springframework.brewery.services.BeerOrderService;
import kmen.springframework.brewery.web.model.*;
...
class BeerOrderControllerTest {
    ...
    void listOrders() throws Exception {
        given(service.listOrders(any(), any())).willReturn(beerOrderPagedList);
    ...
    void getOrder() throws Exception {
        given(service.getOrderById(any(), any())).willReturn(beerOrder);
